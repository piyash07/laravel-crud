          ...
          <div class="row row-offcanvas row-offcanvas-right">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
              <div class="user-info">
                ...
                <div class="details">
                  <p class="user-name">Dav Piyash</p>
              ...
              <ul class="nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" data-toggle="collapse" href="#layoutsSubmenu" aria-expanded="false" aria-controls="layoutsSubmenu">
                    ...
                    <span class="menu-title">Student Informations</span>
                  ...
                  <div class="collapse" id="layoutsSubmenu">
                    <ul class="nav flex-column sub-menu">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="pages/layout/rtl-layout.html">Resul</a>
                      </li>
                ...
                <li class="nav-item">
                  ...
                  <div class="collapse" id="sidebar_layouts">
                    <ul class="nav flex-column sub-menu">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="pages/layout/sidebar-hidden.html">SWE</a>
                      </li>
                      <li class="nav-item">
