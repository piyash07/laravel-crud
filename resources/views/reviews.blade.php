...
<!-- TESTIMONIAL -->
		...
		<div class="item">
		<div class="tst-image">
		     <img src="{{asset('assets/images/tst-image2.jpg')}}" class="img-responsive" alt="">
		</div>
		<div class="tst-author">
		     <h4>Camila</h4>
		...
		<div class="item">
		<div class="tst-image">
		     <img src="{{asset('assets/images/tst-image3.jpg')}}" class="img-responsive" alt="">
		</div>
		<div class="tst-author">
		     <h4>Barbie</h4>
		...
		<div class="item">
		<div class="tst-image">
		     <img src="{{asset('assets/images/tst-image4.jpg')}}" class="img-responsive" alt="">
		</div>
		<div class="tst-author">
		     <h4>Andrio</h4>
